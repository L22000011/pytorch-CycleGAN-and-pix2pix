...
class CycleGANModel(BaseModel):
    ...
    def set_input(self, input):
        ...
        # 加入 mask
        self.A_mask = input.get("A_mask", None).to(self.device) if "A_mask" in input else None
        self.B_mask = input.get("B_mask", None).to(self.device) if "B_mask" in input else None
